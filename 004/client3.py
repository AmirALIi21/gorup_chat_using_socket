...
class ChatClientGUI:
    def __init__(self, root):
        ...
        if self.user_name:
            ...
            self.root.destroy()  # Close if no name is provided
    ...
    def send_message(self):
        ...
        if msg:
            ...
            if msg == DISCONNECT:
                self.root.quit()  # Close window if disconnecting
    ...
    def display_message(self, message):
        ...
        # Check for online members update
        if message.startswith("[SERVER] Online Members:"):
            # You can implement additional UI updates for online members here if needed
            pass
